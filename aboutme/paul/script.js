...
function show_foods(){
	...
	document.getElementById('content_foods').classList.add('selected');
}
function hide_foods(){
	document.getElementById('button_foods').classList.remove('selected');
	document.getElementById('content_foods').classList.remove('selected');
}

function show_colors(){
	document.getElementById('button_colors').classList.add('selected');
	document.getElementById('content_colors').classList.add('selected');
}
window.hide_colors = function(){
	document.getElementById('button_colors').classList.remove('selected');
	document.getElementById('content_colors').classList.remove('selected');
}